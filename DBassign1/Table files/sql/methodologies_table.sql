INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', '2006 IPCC Guidelines for National Greenhouse Gas Inventories AND Guide d''inventaire des émissions de gaz à effet de serre d''un organisme municipal (MDDEP, 2009)', 1, 1);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'A GPC Compliant dataset has been established for Greater Manchester, including primary data from 2013. This work has been undertaken by Anthesis, who also support the World Resources Institute in the development of Carbon Reduction and emissions reporting and trajectory methodologies and reporting tools.', 2, 2);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Also utilized the U.S. Community Protocol for Accounting and Reporting of  Greenhouse Gas Emissions (ICLEI)', 3, 3);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'A note regarding how double counting is avoided for stationary sources:
...
- electricity production due to waste incineration is removed from the electricity total and the associated emissions are part of solid waste sector.', 4, 4);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'as adapted by ICLEI Canada for use in the FCM''s Partners for Climate Protection Program', 5, 5);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Baseline Emission Inventory of the Covenant of Mayor', 6, 6);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Basic Reporting.', 7, 7);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Bilan Carbone', 8, 8);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Calculation Korea Environment Corporation municipal greenhouse gas emissions guidelines ver.4.0 (2015. January)', 9, 9);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Chicago conducts regional GHG emissions inventories in-keeping with rigorous protocol and standards. New GHG methodologies and standards that were not available for previous analyses will be evaluated and adopted for future GHG emissions inventories, as-appropriate. 
 ...
 *Water-borne emissions were included from a private study commissioned by the Port Authority in 2012.', 11, 11);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'CO2-beregneren (National guideline for municipalities)', 12, 12);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Collected data over a 1 year period with the help of many City departments as well as private utility company.', 13, 13);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Community data was collected from local utilities (NV Energy and Southwest Gas), the Nevada Department of Transportation''s Annual VMT Report for Clark County, the Regional Transportation Commission of Southern Nevada, and the Nevada Department of Environmental Protection. These data points were input into ICLEI''s CACP software to obtain aggregated community emission data for Southern Nevada.', 14, 14);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'ConEdison (ConEd) provided data on use of citywide electricity
...
.', 15, 15);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Covenant of Mayors', 16, 16);
...
Tonnages of waste and approximate waste compositions are used in mass balance equations in the calculation of emissions from landfills.', 17, 17);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Data supplied by Department of Energy & Climate Change annually with a two year lag.  Dataset is Local Authority Emissions within scope.', 18, 18);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Department of Energy and Climate Change (DECC) local authority CO2 emissions data', 19, 19);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Developed in partnership with ICLEI/URBAN LEDS Project', 20, 20);
...
The most recent data that are now (April, 2016) available refer to the situation in 2014.', 29, 29);
...
*GPC Pilot version 1.0 (May 2012) was re;eased as draft and opened for comments while the GHG inventory was taking place in Makati. The approach taken to complete the inventory is mostly similar to the one recommended in the Protocol, but there are some differences in content and terminology (e.f. defining inventory boundaries in terms of ''geographic'' and ''geographic+'' instead of ''basic'' and ''basic+''.', 35, 34);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'http://www.citepa.org/fr/activites/inventaires-des-emissions/secten', 36, 35);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Hybrid Demand-Center Life Cycle Assessment Methodology developed by Ramaswami et. al.: The City of Lakewood GHG Emissions Inventory assesses 2007 GHG emissions using a hybrid demand-center life cycle assessment methodology developed by Ramaswami et. al. The method uses the standard Local Government Operations Protocol (LGOP) released by ICLEI\-Local Governments for Sustainability to report GHG emissions from in-boundary activities. Out-of-boundary activities critical to a community such as the provision of food, water, fuels and dwellings are added to the in-boundary activities to yield an expanded inventory that becomes a more comprehensive “carbon emissions footprint”.



In 2015, the City of Lakewood worked with a GHG emissions analyst and updated the 2007 report figures based on more accurate electricity and surface transportation emission factors.', 37, 36);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'ICLEI Clean Air and Climate Protection', 38, 37);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'ICLEI Clean Air and Climate Protection Software', 39, 38);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'ICLEI’s methodology provides a systematic framework for local governments to track energy- and waste-related activities in the community, and to calculate the amounts of greenhouse gases produced by each activity and sector. The inventory methodology involves two sections: a community-wide assessment and a separate inventory of government operations.
...
For our scope, all emissions associated with energy consumed in Baltimore City are included, regardless of the location of the original energy source. This means that, even though the electricity used by Baltimore residents is produced in a plant outside of Baltimore City’s geographical borders, this energy and the emissions associated with it appear in Baltimore City’s inventory. The decision to capture emissions in this way reflects the general philosophy that a community should take full responsibility for the impacts associated with its energy consumption, regardless of where the energy generation occurs.', 40, 257);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', '(ICLEI / The Climate Registry / California Climate Action Registry / California Air Resource Board)', 41, 39);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Identify GHG emissions from potential sector, such energy using, transportation, solid waste, waste water, and industrial.
...
EF: The amount of emissions per uptake per unit', 42, 40);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'IDOM / COBRAPE / BID /PMF (2014)', 43, 41);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'In general the ICLEI protocol was followed, however in some cases data was not available in the same fashion or format as described in the protocol.
...
Waste data was modeled using MSW and private collection data along with local landfill and incinerator emissions based on total waste. This was counted as a scope 3 emissions because none of these facilities are within the City of Philadelphia', 44, 42);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Institut für Energie- und Umweltforschung Heidelberg GmbH', 45, 43);
...
For purposes Rapporteur , the First Emission Inventory of Greenhouse Effect is according to Global Protocol for Communities ( GPC ) , thus the results presented in this paper goes against this global initiative , providing the opportunity for methodological harmonization with other cities around the world .', 46, 44);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'Inventário de Emissões e Remoções Antrópicas de GEE do DF (WayCarbon, 2014)
...
2012', 47, 45);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'Inventory calculated using CACP software using IPCC 1996 Guidelines and US Voluntary Reporting Guidelines. 

(1996 guidelines not available as an option)', 48, 46);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'Inventory report is prepared in accordance with the methodology recommended by the Intergovernmental Panel on Climate Change (IPCC) publications:
...
GHG emissions were calculated from activity levels in the different sectors that are in accordance with the IPCC publications.', 49, 47);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'IPCC', 50, 48);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Irradiare Science of evolution', 51, 49);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'ISO 14064: Data generating activity Greenhouse Gas (GHG) multiplied by the emission factor (EF) or removal of GHG.
...
EFa = corresponds to emission factor generating activity.', 52, 50);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'La metodología Global Protocol for Community- scale Greenhouse Gas emissions (GPC) establece que los límites pueden definirse en cualquiera de tres niveles: Internacional, inter-ciudades/subnacional, o al interior de la ciudad.', 53, 51);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Local standard based on electricity, gas, district heat en local transportation.', 54, 263);
...
Mobile - The London Atmospheric Emissions Inventory (in-house model) is used to calculate distances travelled from transport of people and goods by  road, railways, water-borne navigation, aviation, and off-road surface transport. National emissions factors are applied.', 55, 52);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Methodology included a combination of Environmental Protection Agency (EPA) reported emission factors and EPA recommended emission modeling tools.', 56, 53);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Metodología propia basada en los factores oficiales del Ministerio de Agricultura y Medioambiente para las emisiones directas y en los de la Comisión Nacional de la Energía para las debidas al uso de la electricidad', 57, 54);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'National standard for municipalities in Denmark', 58, 55);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'New York Community and Regional GHG Inventory Guidance: Created by New York GHG Working Group', 59, 56);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'O diagnóstico qualitativo das informações complementa a avaliação quantitativa.', 60, 57);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Oslo gets most of the GHG-data from Statistics Norway and has further developed it to make it compliant with the GPC-protocol. The GPC- reporting was approved september 2015. Statistics Norway did a revision of the GHG-data  in february 2016, but this last revision has not been updated in the GPC-reporting.', 61, 58);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Our BEI (Baseline Emission Inventory) has been made according to the Covenant of Mayors Guide Lines.', 62, 59);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'Partners for Climate Protection - Canadian Supplement to the International Emissions Analysis Protocol', 63, 60);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'PCP Protocol method', 64, 61);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'Please see detailed source notes throughout the inventory document.', 65, 62);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Plus, For Local Government Greenhouse Gas Inventories.,  Korea Environment Corporation, 2010,)', 66, 63);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Quality Assurance/Quality Control. Activities include calculations revision, data management, verification procedures and uncertainties calculation. With models adapted for the Mexico City', 67, 64);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Regionally developed methodology equivalent to GPC (and IPCC guidelines)', 68, 65);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Reported according to the BASIC+ requirement', 69, 66);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Rio de Janeiro was one of the pilot cities to use the GPC first version. We updated the last inventory (2005) and calculated the new one (2012). We used IPCC 2006 with some adaptations to the local context, following the GPC requirements and procedures.', 70, 67);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'See LGO1.3 attachment', 71, 68);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Software ECORegion smart from the

Climate Alliance', 72, 69);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Sustainable Energy Action Plan Guide Line', 73, 70);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', ' Sustainable Energy Action Plan (SEAP) + SEAP Monitoring Report: Águeda’s SEAP holds a total carbon reduction potential of 33% by 2020, using 2002 as the reference year. The considered actions will also result in substantial economical benefits for the region’s citizens, companies and municipality, estimated at an average of 8 million Euros per year.An average investment of 3,3 million Euros per year is required to implement the actions included in the SEAP, but the bulk of this cost can be supported by external investment (public incentives, bank loans, ESCO models and the transaction of white certificates and carbon credits), which reduces to 1,2 million Euros per year the investment to be supported by the region’s citizens, companies and municipality.', 74, 71);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Taipei city using GPC methodology to make City GHG inventory since 2014.', 75, 72);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'TCR/LGOP', 76, 73);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The 2000-Watt society methodology is a concept of sustainable development that uses two indicators: Primary energy demand and greenhouse gas emissions. The methodology is based on the final energy demand. Primary energy factors and GHG emission coefficients are according to the ecoinvent database (database with consistent and transparent, up-to-date Life Cycle Inventory (LCI) data – www.ecoinvent.org/database/). The grey energy of net imported other goods and services is not included in the methodology used by the city of Zurich as there is no specific data available. The methodology does not include emissions from non-energetic sources (e.g. landfills, waste water treatment).
...
http://hestia.project.asu.edu/uploads/Gurney.ES&T.2012.final.proof.pdf', 89, 86);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The Delaware Valley Regional Planning Commission (DVRPC) is the designated Metropolitan Planning Organization (MPO) for the Greater Philadelphia Region. DVRPC works to promote regional cooperation
...
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The GHG emissions inventory was developed through the energy supply and demand data by the Portuguese Directorate-General for Energy and Geology (www.dgeg.pt) and the National Statistics Institute (www.ine.pt). The Transports sector was estimated through a separate and specific mobility needs model.', 96, 93);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The guideline set by the Ministry of environmnet , Japan', 97, 94);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'The IPCC guidelines in 2006 for GHG inventories, specifically for modules: energy, industrial processes and products use, waste and forestry module and land uses.', 98, 258);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'the IPCC methodology was followed , implementing all the criteria therein following the classification.', 99, 95);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'The methodology as defined in the International Local Government GHG Emissions Analysis Protocol V1.0 and the Local Government Operations Protocol for the Quantification and Reporting of GHG Inventories V1.1 where used where applicable and viable.', 100, 96);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The methodology is explained in more detail in the peer-reviewed  journal paper "A Demand-Centered, Hybrid Life-Cycle Methodology for City-Scale Greenhouse Gas Inventories" located at http://pubs.acs.org/doi/abs/10.1021/es702992q .', 101, 97);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'The methodology that was used was through ICLEI in 2009 using Clean Air and Climate Protection (CACP2009) software.', 102, 98);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The methodology used provides an inventory of greenhouse gases at the municipality level, divided into sectors. The sectors are similar to those used for the official Danish emission inventory (IPCC sectors), and include; collective power and heating, Indivitual heating, Mobile sources, Tranportation and machinery, Industrial processes, Solvents, Agriculture, Land use, and waste depositing and wastewater.
...
Another category that deserves observation refers to the disposal of solid waste in landfills. For this category we used the GPC, which allocates all expected emissions inventory in the year in which the waste is landfilled, IIS was not used for the calculation of this emission source.', 106, 102);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The SEAP consists of two parts:
...
E ''was structured by defining n. 8 sectors of intervention for each specific actions are identified (n. 25) outlined in tabs that slope down detailed rules for implementation and the resources that the Town Council intends to put in place.', 107, 103);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'The Stockholm proprietary method
...
Energy statistics are collected from different sources: district heating & gas statistics are collected from the companies; electricity statistics is compiled and collected from Statistics Sweden; emissions from road transport is modeled using an extensive emission model combined with a road model over Stockholm (includes a variety vehicles, speeds, road types etc) and non-road emissions are taken from Statistics Sweden; marine emissions within the community boundary are based on emissions & energy use presented in environmental reports from shipping companies and Ports of Stockholm.', 108, 104);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'This energy consumption ´s data were collected from Directorate General for Energy and Geology (DGEG)', 109, 105);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'This inventory was assembled through the collection and analysis of data with City of Cleveland staff as well as other city stakeholders such as utilities, regional coordinating agencies, local organizations and large emitters. Associated GHG emissions for all activities were calculated using an approach consistent with the International Council for Local Environmental Initiatives (ICLEI) - U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI) as the main guiding document, with methodologies from The Climate Registry (TCR), the World Resources Institute (WRI), the Intergovernmental Panel on Climate Change (IPCC), and the U.S. Environmental Protection Agency (EPA) also referenced. 



Tools - Inventory Management System:

Most of the calculations used to develop this inventory were carried out in an Information Management System (IMS), a Microsoft Excel-based spreadsheet that collects into one tool the original data, methodology applied, emission factors selected and a summary of GHG emission results. The IMS also provides charting, forecasting and benchmarking capabilities', 110, 106);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'This inventory were considered for calculating the following greenhouse gases ( GHG ) : Carbon Dioxide ( CO2 ), methane ( CH4 ) , nitrous oxide ( N2O ) , Hydrochlorofluorocarbons ( HFC " s ) , Perclorofluorcarbonos ( PFC " s ) and hexafluoride Sulfur ( SF6 ) . , 2000 IPCC Good Practice Guidance and Management in Natural Uncertanty Greenhouse Gas Inventories ; 2006 IPCC Guidelines for National , Greenhouse Gas Inventories ISO 14064-1/2006 : To estimate GHG emissions in Sorocaba , the following references were used : Greenhouse Gases , ISO 14064-2/2007 : Greenhouse Gases , Global Protocol for Community - Scale Greenhouse Gas Emissions ( GPC ) 2012. Potential GHG Global Warming was used , according to the Second Assessment Report of the IPCC (1995 ) . The sectors analyzed were : agriculture, forestry and land use ( rice planting in irrigated systems , liming the soil , herd management and animal manure management , agricultural soil management , agricultural waste burning and land use change ) , energy ( mobile combustion , stationary combustion and electricity consumption ) ; industry , and waste ( landfill and sewage treatment ) . Databases respected in the country , as the IBGE and SEADE were used , in addition to consulting the ANP ( National Petroleum Agency ) , municipal government information , agencies and agriculture companies .', 111, 107);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'This is the first year using this protocol. The inventory was completed to a BASIC level.', 112, 108);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'This protocol was adopted for the 2012 inventory. Previous inventories followed a different methodology making an apples to apples comparison difficult. It is the city''s intention to follow the GPC, in addition to the U.S. Community Protocol, for the 2015 inventory, expected completion by December 2016.', 113, 109);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'This was applied in compliance with the national Partners for Climate Protection program,', 114, 110);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'this was made with calculous platforms from international organizations such as UN (IPCC, and ICLEI) as well as EU comission', 115, 111);
...
The GPC BASIC inventories show lower emissions compared with inventories based on the CCAP tool due to different methodologies and emissions sources. Future year’s reports may be subject to change as the City of Sydney will be updating its inventories in the short term for achieving beyond GPC BASIC compliance.', 116, 112);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'Transportation, fuel oil use, and solid waste emissions data are the most recent available, from a 2012 inventory. Electricity and natural gas consumption in the community reflect actual 2015 data based on utility reporting.', 117, 113);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Used ICLEI U.S. Community Protocol to verify calendar year 2012 emissions.  During November 2015, the city reshaped and scoped calendar year 2012 emissions according to the new GPC BASIC framework to Compact of Mayors requirements.  The GPC expanded the scope of the verified 2012 inventory to report sources such as from natural gas leakage from the distribution system, district electricity, transmission and distribution electric losses, wastewater, agriculture/farming, ships and boats (non-ferry), off-road equipment and stationary sources.  This resulted in a higher emission number than originally verified by a third party.', 118, 114);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'Used the community GHG accounting tool available from ICLEI at the time (2006/2007)', 119, 115);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'Version 1 (published in 2014)', 120, 116);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'Waste information directly from Public Works and reports to Ministry of Environment re: energy capture of methane control at landfill
...
Commercial, Residential, Industrial (not Steel) from local electricity and natural gas utilities', 121, 117);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'We also participated in the GPC community inventory pilot in 2015. We were the only city from the US in their initial pilot.', 122, 118);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', 'We are using the 4th edition of the Protocol.', 123, 119);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'We didn''t adopt any specific Protocol, anyway, let apart a few details,  the adopted methodology is compliant with the GPC Protocol. Just part of it. With respect to compact basic requirements (first year after the adhesion) only urban railway is missing, we are collecting data regarding this', 124, 120);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', 'We have measured energy but used a methodology similar to WRI. We used NYSERDA'' s emission factor.', 125, 121);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'Well, this is the total emissions as we only calculate scope 1. As I understand scope 1 this is scope 1 emissions, due to activities of citizens and businesses within the city limits, waste and flight / shipping. Emissions from energy generation is not included. That kind of emission is though very low as our energy and district heating runs on Hydro power and geothermal heat. We are not counting emissions from activities outside of the borders of the city, such as emissions from the international airport which is outside of Reykjavik and not the emissions of any production outside of the city which I understand is scope 3.', 126, 122);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'We made reference to the "2006 IPCC Guidelines for National Greenhouse Gas Inventories".', 127, 123);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'We used only one methodology: the 2006 IPCC Guidelines for National Greenhouse Gas Inventory. Data was collected or estimated from official sources.', 128, 124);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', 'We used the 2010 version of the ICLEI Protocol', 129, 259);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', 'With some national modifications', 130, 125);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'Yokohama determines levels of greenhouse gas (GHG) emissions, promotes their reduction, and manages the progress of reduction on the basis of the Yokohama City Action Plan for Global Warming Countermeasures (district measure revised edition; 2014), which was prepared in accordance with the provisions of Article 20, Item 3, Paragraph 3 of the Act on Promotion of Global Warming Countermeasures.  It measures GHG emissions in accordance with “the manual for formulation of action plans by local public entities for global warming countermeasures (regional measure edition, 2014)”, which was formulated by the Ministry of the Environment.', 131, 262);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', 'コメント欄のとおり: 地球温暖化対策地方公共団体実行計画（区域施策編）策定マニュアル（第１版）に基づき、市内における人為的な活動に伴う排出量を把握している。', 132, 126);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', '環境省のマニュアル', 133, 127);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 134, 128);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', NULL, 135, 129);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 136, 130);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 137, 131);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 138, 132);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 139, 133);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 140, 134);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', NULL, 141, 135);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 142, 136);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 143, 137);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 144, 138);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 145, 139);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 146, 140);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 147, 141);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 148, 142);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 149, 261);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 150, 143);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 151, 144);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 152, 145);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 153, 146);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 154, 147);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 155, 148);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 156, 149);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 157, 150);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 158, 151);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 159, 152);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', NULL, 160, 153);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 161, 154);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 162, 155);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 163, 156);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 164, 157);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 165, 158);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 166, 159);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Other', NULL, 167, 160);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 168, 161);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 169, 162);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 170, 163);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 171, 164);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 172, 165);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 173, 166);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 174, 167);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 175, 168);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 176, 169);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 177, 170);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 178, 171);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 179, 172);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( '2006 IPCC Guidelines for National Greenhouse Gas Inventories', NULL, 180, 173);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 181, 174);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 182, 175);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 183, 176);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'U.S. Community Protocol for Accounting and Reporting of Greenhouse Gas Emissions (ICLEI)', NULL, 184, 177);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 185, 178);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'International Emissions Analysis Protocol (ICLEI)', NULL, 186, 179);
INSERT INTO Methodologies ( primary_methodology, details, methodology_id, emission_id) VALUES ( 'Global Protocol for Community-Scale Greenhouse Gas Emissions Inventories (GPC), (WRI, C40 and ICLEI)', NULL, 187, 180);
